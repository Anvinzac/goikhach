...
import { glowPulse, noticePulse } from './animations';
  ...
  return (
    <motion.div className="relative w-full mx-auto overflow-hidden" initial="hidden" animate="visible">
      ...
      >
        ...
        {/* Daily special */}
        {data.dailySpecial && (
          <motion.div className="rounded-2xl px-3 py-2 mb-3 border" style={{ background: theme.surface, borderColor: theme.surfaceBorder }} custom={6} variants={fadeUp} animate={noticePulse(theme.primary)}>
